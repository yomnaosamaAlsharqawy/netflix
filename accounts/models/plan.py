...
class Plan(models.Model):
    ...
    video_quality = models.CharField(choices=VIDEO_QUALITY_CHOICES, default=VIDEO_QUALITY_CHOICES[0], max_length=10,
                                     null=False)
    # resolution = models.IntegerField(choices=(480, 720, 1080), default=480, null=False)
    screen_count = models.IntegerField(choices=SCREEN_COUNT, default=SCREEN_COUNT[0], null=False)
